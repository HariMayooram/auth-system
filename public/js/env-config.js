(function(window) {
    ...
    if (isGithub) {
        ...
        authApiUrl = authApiUrl || 'https://webroot-auth-api-336235334145.us-central1.run.app/api'; // Use global or default
        ...
        authApiUrl = authApiUrl || 'https://webroot-auth-api-336235334145.us-central1.run.app/api'; // Fallback to deployed URL for non-localhost
